...
var $author$project$Twigen$choice = function (list) {
	if (!list.b) {
...
var $author$project$Twigen$c = $elm$random$Random$constant;
var $author$project$Twigen$KeiyousiGokan = function (a) {
	return {$: 'KeiyousiGokan', a: a};
};
var $author$project$Twigen$Rentai = {$: 'Rentai'};
var $author$project$Twigen$Katuyougobi = F6(
...
var $author$project$Twigen$dousiKatuyou = F2(
	function (katuyoukei, dousi) {
		var _v0 = dousi;
		var gokan = _v0.a;
		var katuyou = _v0.b;
		var _v1 = $author$project$Twigen$katuyougobi(katuyou);
		var mizen = _v1.a;
		var _v2 = _v1.b;
		var renyou1 = _v2.a;
		var renyou2 = _v2.b;
		...
		return _Utils_ap(gokan, gobi);
	});
var $author$project$Twigen$dousiKuKatuyou = F2(
	function (katuyoukei, _v0) {
		var syuusyoku = _v0.a;
		var dousi = _v0.b;
		return _Utils_ap(
			syuusyoku,
			A2($author$project$Twigen$dousiKatuyou, katuyoukei, dousi));
	});
...
var $author$project$Twigen$keiyousiRentai = $author$project$Twigen$keiyousiKatuyou($author$project$Twigen$Rentai);
var $author$project$Twigen$Renyou2 = {$: 'Renyou2'};
var $author$project$Twigen$keiyousiRenyou2 = $author$project$Twigen$keiyousiKatuyou($author$project$Twigen$Renyou2);
			...
			[
				...
				F3(
					function (dk, y, d2) {
						return _Utils_Tuple2(
							_Utils_ap(
								$author$project$Twigen$dousiKuRentai(dk),
								y),
							d2);
					}),
				$elm$random$Random$lazy(
				...
				F2(
					function (k, _v5) {
						...
						return _Utils_Tuple2(
							_Utils_ap(
								$author$project$Twigen$keiyousiRenyou2(k),
								s),
							d);
					}),
				$elm$random$Random$lazy(
...
var $author$project$Twigen$dousiKuSyuusi = $author$project$Twigen$dousiKuKatuyou($author$project$Twigen$Syuusi);
var $author$project$Twigen$keiyousiSyuusi = $author$project$Twigen$keiyousiKatuyou($author$project$Twigen$Syuusi);
var $author$project$Twigen$seq = function (list) {
	if (!list.b) {
		return $elm$random$Random$constant('');
	} else {
		var hd = list.a;
		...
		return A3(
			$elm$random$Random$map2,
			F2(
				function (hdStr, tlStr) {
					return _Utils_ap(hdStr, tlStr);
				}),
			hd,
...
var $author$project$Twigen$dagaomaeha = function (tango) {
	var ore = $author$project$Twigen$choice(
		_List_fromArray(
			[
				$author$project$Twigen$c('俺'),
				$author$project$Twigen$c('ワイ'),
				$author$project$Twigen$c('私')
			]));
	var omae = $author$project$Twigen$choice(
		_List_fromArray(
			[
				$author$project$Twigen$c('お前'),
				$author$project$Twigen$c('きみ'),
				$author$project$Twigen$c('あなた')
			]));
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$Twigen$c('だ'),
								$author$project$Twigen$c('である'),
								$author$project$Twigen$c('でない'),
								$author$project$Twigen$c('でできている')
							]))
					])),
				$author$project$Twigen$seq(
				_List_fromArray(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						body,
						$author$project$Twigen$c('． #宣言的知識')
					])),
				$author$project$Twigen$seq(
				_List_fromArray(
					[
						body,
						$author$project$Twigen$c('（ホンマか？')
					])),
				$author$project$Twigen$seq(
				_List_fromArray(
					[
						body,
						$author$project$Twigen$c('．知らんけど．')
					])),
				$author$project$Twigen$seq(
				_List_fromArray(
					[
						body,
						$author$project$Twigen$c('って魔剤？')
					])),
				$author$project$Twigen$seq(
				_List_fromArray(
					[
						$author$project$Twigen$c('もしかして：'),
						body
					]))
			]));
};
	...
	function (at, tango) {
		var help = F3(
			function (at_, rest, result) {
				help:
				while (true) {
					var _v0 = _Utils_Tuple2(at_, rest);
					if (_v0.b.b) {
						if (!_v0.a) {
							var _v1 = _v0.b;
							var hd = _v1.a;
...
var $author$project$Twigen$dousiSyuruiFromString = function (syurui) {
	switch (syurui) {
		case '自動詞':
			return $elm$core$Maybe$Just($author$project$Twigen$Jidousi);
		case '他動詞':
...
var $author$project$Twigen$katuyouFromString = F2(
	function (gyou, katuyou) {
		switch (katuyou) {
			case '五段':
				return $elm$core$Maybe$Just(
					$author$project$Twigen$Godan(gyou));
			case '上一':
				return $elm$core$Maybe$Just(
					$author$project$Twigen$Kami(gyou));
			case '下一':
				return $elm$core$Maybe$Just(
					$author$project$Twigen$Shimo(gyou));
			case 'さ変格':
				return $elm$core$Maybe$Just($author$project$Twigen$Sahen);
			default:
				return $elm$core$Maybe$Nothing;
		}
	});
...
var $author$project$Twigen$dousiTuika = F2(
	function (settei, tango) {
		var dousi_ = A3(
			...
			F2(
				function (k, s) {
					return A3($author$project$Twigen$Dousi, settei.gokan, k, s);
				}),
			A2($author$project$Twigen$katuyouFromString, settei.gyou, settei.katuyoukei),
			$author$project$Twigen$dousiSyuruiFromString(settei.syurui));
		var list_ = function () {
			if (dousi_.$ === 'Just') {
				var d = dousi_.a;
...
var $author$project$Twigen$gokanSettei = F2(
	function (settei, gokan) {
		return $author$project$Twigen$TuikaSetteiUpdate(
			_Utils_update(
				settei,
				{gokan: gokan}));
	});
var $author$project$Twigen$gyouSettei = F2(
	function (settei, gyou) {
		return $author$project$Twigen$TuikaSetteiUpdate(
			_Utils_update(
				settei,
				{gyou: gyou}));
...
var $author$project$Twigen$katuyouToString = function (katuyou) {
	switch (katuyou.$) {
		case 'Godan':
			var gyou = katuyou.a;
			return gyou + '五段';
...
var $author$project$Twigen$katuyoukeiSettei = F2(
	function (settei, katuyoukei) {
		return $author$project$Twigen$TuikaSetteiUpdate(
			_Utils_update(
				settei,
...
var $author$project$Twigen$syuruiSettei = F2(
	function (settei, syurui) {
		return $author$project$Twigen$TuikaSetteiUpdate(
			_Utils_update(
				settei,
				{syurui: syurui}));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Twigen$Roll)
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$text(
																$author$project$Twigen$katuyouToString(katuyou))
															])),
														A2(
														$elm$html$Html$td,
														_List_Nil,
														_List_fromArray(
															[
																$elm$html$Html$text(
																$author$project$Twigen$dousiSyuruiToString(syurui))
															])),
														A2(
														$elm$html$Html$td,
														_List_Nil,
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onInput(
								$author$project$Twigen$gyouSettei(model.tuikaSettei))
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('あ行')
									])),
								A2(
								$elm$html$Html$option,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$value('か')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('か行')
									])),
								A2(
								$elm$html$Html$option,
								_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onInput(
								$author$project$Twigen$katuyoukeiSettei(model.tuikaSettei))
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$value('五段')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('五段')
									])),
								A2(
								$elm$html$Html$option,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$value('上一')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('上一')
									])),
								A2(
								$elm$html$Html$option,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$value('下一')
									]),
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onInput(
								$author$project$Twigen$syuruiSettei(model.tuikaSettei))
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$value('自動詞')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('自動詞')
									])),
								A2(
								$elm$html$Html$option,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$value('他動詞')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('他動詞')
									])),
								A2(
								$elm$html$Html$option,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$value('両方')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('両方')
									]))
							])),
						A2(
						$elm$html$Html$button,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$attribute, 'data-text', 'くすっとできるクソツイを生成'),
				A2($elm$html$Html$Attributes$attribute, 'data-url', 'https://yuyaaizawa.github.io/Twigen/'),
